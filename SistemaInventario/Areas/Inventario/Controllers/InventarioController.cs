...
namespace SistemaInventario.Areas.Inventario.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        //Métodos agregar y disminuir
        public async Task<IActionResult> Mas(int id)// recibo el ID del detalle
        {
            inventarioVM = new InventarioVM();
        ...
        public async Task<IActionResult> Menos(int id)// recibo el ID del detalle
        {
            inventarioVM = new InventarioVM();
            var detalle = await _unidadTrabajo.InventarioDetalle.Obtener(id);
            inventarioVM.Inventario = await _unidadTrabajo.Inventario.Obtener(detalle.InventarioId);
        ...
        public async Task<IActionResult> GenerarStock(int id)
        {
            ...
            foreach (var item in detalleLista)
            {
                ...
                else // Registro de stock no existe, he qye crearlo
                {
            ...
            //Actualizar la cabera del inventario
        ...
        //Método para generar Kardex por Producto
        ...
        [HttpPost]
        public async Task<IActionResult> KardexProducto(string fechaInicioId, string fechaFinalId, int productoId)
        {
            return RedirectToAction("KardexProductoResultado", new {fechaInicioId,fechaFinalId,productoId});
        }

        //Método que filtra información del Kardex
        ...
        public async Task<IActionResult> BuscarProducto(string term)
        {
            if (!string.IsNullOrEmpty(term))
            {
                ...
                //Filtrando por numero de serie o descripcion
